...
* NodeJS: [pnpm-based guide](https://pnpm.io/cli/env)
...
```sh
cd contract-toolset && pnpm install
```
...
Note: You will need to add a hex prefix '0x' to the exported private key.
